...
# Normal
NAME = so_long
FUNC = src/draw_map.c src/error.c src/exit.c src/free.c src/game_event.c src/game_event2.c \
		src/game_init.c src/map_dimension.c src/map_utils.c src/map_validate.c src/map_validate_utils.c \
		src/map.c src/so_long.c src/valid_path.c src/valid_path_utils.c \
		src/utils/printf.c src/utils/printf_utils.c src/utils/other_utils.c src/utils/get_next_line.c src/utils/itoa.c
OBJS = ${FUNC:.c=.o}
...
FUNC_BONUS = src_bonus/draw_map.c src_bonus/error.c src_bonus/exit.c src_bonus/free.c src_bonus/game_event.c src_bonus/game_event2.c \
			...
			src_bonus/map.c src_bonus/so_long_bonus.c src_bonus/anim.c src_bonus/keyboard_action.c src_bonus/valid_path.c src_bonus/valid_path_utils.c \
